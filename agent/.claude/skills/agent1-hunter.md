...
### 搜索参数
- **关键词**: `"香港买房经历"`, `"香港看房日记"`, `"香港上车记"`, `"香港买房分享"`, `"香港业主自述"`, `"我终于在香港买房"`, `"香港收楼记"`, `"港岛买房心得"`, `"香港小家"`, `"香港买房记录"`
- **关键词设计原则**: 使用素人常用语（经历/日记/分享/记录/自述），避免中介术语（放盘/笋盘/急售），从源头过滤中介视角笔记
- **每关键词页数**: 2 页
...
### 时效性过滤（v2.0 新增）
- **配置**: `PUBLISHED_WITHIN_DAYS = 30`（只要最近 30 天内发布的笔记）
